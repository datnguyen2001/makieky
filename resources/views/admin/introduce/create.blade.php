            ...
            <div class="bg-white p-4">
                <form action="{{route('admin.introduce.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <textarea name="describe" class="form-control" cols="30" rows="6" required>{{ old('describe') }}</textarea>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body mt-2">
                            <textarea name="content" id="content" class="ckeditor" required>{{ old('content') }}</textarea>
                        </div>
