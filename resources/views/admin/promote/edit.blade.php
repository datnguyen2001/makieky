...
@section('main')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Cập nhật quảng bá</h1>
        </div><!-- End Page Title -->
        <section class="section dashboard">
            <div class="bg-white p-4">
                <form action="{{url("admin/promote/update",$promote->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mt-3">
                        <div class="col-3">Tiêu đề: </div>
                        <div class="col-8">
                            <input type="text" class="form-control" name="name" value="{{$promote->name}}" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                            ...
                            <div class="form-control position-relative div-parent" style="padding-top: 50%">
                                <div class="position-absolute w-100 h-100 div-file" style="top: 0; left: 0;z-index: 10">
                                    <button type="button" class="position-absolute clear border-0 bg-danger p-0 d-flex justify-content-center align-items-center" style="top: -10px;right: -10px;width: 30px;height: 30px;border-radius: 50%"><i class="bi bi-x-lg text-white"></i></button>
                                        <img src="{{asset($promote->src)}}" class="w-100 h-100" style="object-fit: cover">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" name="link" required value="{{$promote->link}}">
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <div class="form-check form-switch">
                                <input class="form-check-input" name="display" @if($promote->display == 1) checked @endif type="checkbox"
