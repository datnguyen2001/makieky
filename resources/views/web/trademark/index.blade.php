...
@section('content')
    ...
    <div class="box-content-web mb-5">
        <div class="product-breadcrumb">
            ...
            <span class="item-breadcrumb item-breadcrumb-active">{{$nameTrademark}}</span>
        </div>
        <p class="title-all-category">{{$nameTrademark}}</p>
            ...
            <div class="sort-by">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item px-2" href="{{ route('trademark', ['slug' => $slug, 'sort' => 'newest']) }}">Hàng mới về</a></li>
                        <li><a class="dropdown-item px-2" href="{{ route('trademark', ['slug' => $slug, 'sort' => 'bestselling']) }}">Bán chạy nhất</a></li>
                        <li><a class="dropdown-item px-2" href="{{ route('trademark', ['slug' => $slug, 'sort' => 'price_asc']) }}">Giá thấp đến cao</a></li>
                        <li><a class="dropdown-item px-2" href="{{ route('trademark', ['slug' => $slug, 'sort' => 'price_desc']) }}">Giá cao đến thấp</a></li>
                        <li><a class="dropdown-item px-2" href="{{ route('trademark', ['slug' => $slug, 'sort' => 'name_asc']) }}">Name A-Z</a></li>
                    </ul>
                </div>
            </div>
        </div>
